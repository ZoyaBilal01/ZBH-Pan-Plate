/* Chinese recipes — batch 3 (more classics) */
addRecipe({ name: "Beef and Broccoli", cuisine: "Chinese", category: "Main Course",
  description: "Tender beef stir-fried with broccoli in a glossy oyster sauce.",
  ingredients: ["Beef","Broccoli","Garlic","Ginger","Soy Sauce","Oyster Sauce","Corn Flour","Oil"],
...
addRecipe({ name: "Spring Rolls", cuisine: "Chinese", category: "Appetizer",
  ...
  ingredients: ["Spring Roll Wrapper","Cabbage","Carrot","Glass Noodles","Soy Sauce","Garlic","Oil"],
...
addRecipe({ name: "Wonton Soup", cuisine: "Chinese", category: "Soup",
  ...
  ingredients: ["Wonton Wrapper","Minced Meat","Shrimp","Garlic","Ginger","Soy Sauce","Spring Onion","Stock"],
...
addRecipe({ name: "Hot and Sour Soup", cuisine: "Chinese", category: "Soup",
  ...
  ingredients: ["Tofu","Mushroom","Egg","Vinegar","Soy Sauce","Corn Flour","Red Chili","Spring Onion"],
...
addRecipe({ name: "Chow Mein (Veg)", cuisine: "Chinese", category: "Noodles",
  ...
  ingredients: ["Noodles","Cabbage","Carrot","Bell Pepper","Mushroom","Soy Sauce","Garlic","Oil"],
...
addRecipe({ name: "Egg Drop Soup", cuisine: "Chinese", category: "Soup",
  ...
  ingredients: ["Stock","Egg","Corn Flour","Garlic","Spring Onion","Salt","White Pepper"],
...
addRecipe({ name: "Sweetcorn Chicken Soup", cuisine: "Chinese", category: "Soup",
  ...
  ingredients: ["Corn","Chicken","Egg","Corn Flour","Ginger","Salt","White Pepper"],
...
addRecipe({ name: "Salt and Pepper Prawns", cuisine: "Chinese", category: "Appetizer",
  ...
  ingredients: ["Shrimp","Corn Flour","Garlic","Green Chili","Spring Onion","Salt","Black Pepper","Oil"],
