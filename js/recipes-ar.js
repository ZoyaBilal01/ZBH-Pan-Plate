...
addRecipe({ name: "Chicken Shawarma", cuisine: "Arabic", category: "Main Course",
  ...
  ingredients: ["Chicken","Yogurt","Cumin","Paprika","Garlic","Lemon","Pita","Pickles"],
...
addRecipe({ name: "Falafel", cuisine: "Arabic", category: "Appetizer",
  ...
  ingredients: ["Chickpeas","Parsley","Coriander","Garlic","Cumin","Onion","Flour","Oil"],
...
addRecipe({ name: "Kabsa", cuisine: "Arabic", category: "Rice",
  ...
  ingredients: ["Basmati Rice","Chicken","Onion","Tomato","Raisins","Almonds","Garam Masala","Cardamom","Salt"],
...
addRecipe({ name: "Tabbouleh", cuisine: "Arabic", category: "Salad",
  ...
  ingredients: ["Parsley","Bulgur","Tomato","Cucumber","Mint","Lemon","Olive Oil","Salt"],
...
addRecipe({ name: "Shish Tawook", cuisine: "Arabic", category: "BBQ",
  ...
  ingredients: ["Chicken","Garlic","Lemon","Yogurt","Paprika","Cumin","Salt"],
...
addRecipe({ name: "Fattoush", cuisine: "Arabic", category: "Salad",
  ...
  ingredients: ["Lettuce","Cucumber","Tomato","Radish","Pita","Sumac","Lemon","Olive Oil"],
...
addRecipe({ name: "Maqluba", cuisine: "Arabic", category: "Main Course",
  ...
  ingredients: ["Basmati Rice","Eggplant","Chicken","Cauliflower","Onion","Cumin","Cardamom","Salt"],
